...
class FormBarang(ModelForm):
    class Meta: ## data yang mau digunakan untuk membuat formnya
        model= Barang ## model dari form apa yang akan ditambah data.
        fields= '__all__' ## semua kolom digunakan untuk tambah data 
        widgets= {
